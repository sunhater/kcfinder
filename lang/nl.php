...
$lang = array(
    ...
    "Cannot write to upload folder." => "Kan niet naar de upload map schrijven.",
    ...
    "Cannot read upload folder." => "Upload map kan niet uitgelezen worden.",
    ...
    "Cannot access or write to upload folder." => "Het is niet mogelijk om in de upload map te schrijven of deze te benaderen.",
    ...
    "Non-existing directory type." => "Het map type bestaat niet.",
